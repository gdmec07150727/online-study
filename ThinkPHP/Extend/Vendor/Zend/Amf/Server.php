...
class Zend_Amf_Server implements Zend_Server_Interface
{
   ...
   /**
        ...
        if (!isset($this->_table[$qualifiedName])) {
            ...
            if ($source) {
                ...
                try {
                    ...
                    require_once 'Zend/Amf/Server/Exception.php';
                    throw new Zend_Amf_Server_Exception('Classes "' . $className . '" does not exist: '.$e->getMessage());
                }
     ...
     *
     * Classes may be either a class name or an instantiated object. Reflection
