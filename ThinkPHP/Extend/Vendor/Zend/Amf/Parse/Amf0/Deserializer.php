 ...
 *
 * @todo       Implement Typed Object Classes Mapping
 * @todo       Classes could be implmented as Factory Classes with each data type it's own class
 * @package    Zend_Amf
 * @subpackage Parse_Amf0
 * @copyright  Copyright (c) 2005-2009 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
...
class Zend_Amf_Parse_Amf0_Deserializer extends Zend_Amf_Parse_Deserializer
{
    ...
    public function readTypeMarker($typeMarker = null)
    {
        ...
        switch($typeMarker) {
            ...
            // typed object ie Custom Classes
    ...
    /**
     * Read Classes that is to be mapped to a server class.
     *
     * Commonly used for Value Objects on the server
     *
     * @todo   implement Typed Classes mapping
     * @return object|array
