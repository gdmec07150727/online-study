    ...
    */
    public function enableSecurity($security_class = null)
    {
        if ($security_class instanceof Smarty_Security) {
            ...
            throw new SmartyException("Classes '" . get_class($security_class) . "' must extend Smarty_Security.");
        }
        ...
        if (!class_exists($security_class)) {
            ...
            throw new SmartyException("Classes '$security_class' must extend Smarty_Security.");
        } else {
